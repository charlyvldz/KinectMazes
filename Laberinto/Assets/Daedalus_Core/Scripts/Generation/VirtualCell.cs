...
public class VirtualCell
{
	...
	public List<CellLocation> connectedCells = new List<CellLocation> (); // TODO: Check the usage of this, which is not used for now. A graph representation may be useful for connected cells checking
	...
	public CellType Type {
		get {
			if (this.instances.Count == 0) return CellType.None;	// TODO: Check that this is correct! It may happen that the type is removed by the stairs. If this happens, then the cell is basically empty, hence why it should be a Ninguno.
	...
	public bool IsHorizontal(){
		return this.Orientation == VirtualMap.DirectionType.East || this.Orientation == VirtualMap.DirectionType.North;
	}
}
