...
public class VirtualRoom
{
	...
	public List<VirtualRoom> connectedRooms;
	...
	public VirtualRoom (int w, int h, CellLocation l)
	{
		...
		connectedRooms = new List<VirtualRoom> ();
...
//	{
//		foreach (VirtualRoom r in connectedRooms) {
...
//	}
	...
	public bool IsConnectedToARoomAt(CellLocation l){
		foreach(VirtualRoom r in this.connectedRooms){
