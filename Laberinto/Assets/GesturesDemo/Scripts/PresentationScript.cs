...
public class PresentationScript : MonoBehaviour 
{
	...
	void Update() 
	{
		...
		KinectManager kinectManager = KinectManager.AdministradorKinect;
		if(autoChangeAlfterDelay && (!kinectManager || !kinectManager.EstaActivoelSensor() || !kinectManager.IsUserDetected()))
			return;
