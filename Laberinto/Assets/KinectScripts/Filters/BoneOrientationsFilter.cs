...
/// <summary>
/// Implementation of a Holt Double Exponential SuavizadoEscena filter for orientation. The double 
...
public class BoneOrientationsFilter
{
    ...
    // The transform SuavizadoEscena parameters for this filter.
    ...
    /// </summary>
    /// <param name="smoothingValue">SuavizadoEscena = [0..1], lower values is closer to the raw data and more noisy.</param>
    ...
    public void Init(float smoothingValue, float correctionValue, float predictionValue, float jitterRadiusValue, float maxDeviationRadiusValue)
    {
        ...
        this.smoothParameters.fJitterRadius = jitterRadiusValue;             // Size of the radius where jitter is removed. Can do too much SuavizadoEscena when too high
    ...
    // Implements a double exponential SuavizadoEscena filter on the skeleton bone orientation quaternions.
...
//        int jointIndex = (int)jt;
        ...
        else
        {
            ...
            // Now the double exponential SuavizadoEscena filter
